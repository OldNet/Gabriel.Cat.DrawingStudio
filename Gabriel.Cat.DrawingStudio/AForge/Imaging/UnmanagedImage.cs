...
namespace AForge.Imaging
{
    ...
    public class UnmanagedImage : IDisposable
    {
        ...
        /// 
        public UnmanagedImage( IntPtr imageData, int width, int height, int stride, PixelFormat pixelFormat ,bool isArgb=false)
        {
        ...
        /// 
        public UnmanagedImage( BitmapData bitmapData ,bool isArgb=false)
        {
        ...
        public UnmanagedImage(Bitmap bmp) : this(bmp.LockBits(), bmp.IsArgb()) { }
        /// <summary>
